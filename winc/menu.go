...
func (mi *MenuItem) OnMClick() *EventManager {
	return &mi.onMClick
}
...
func (mi *MenuItem) WndProc(msg uint32, wparam, lparam uintptr) uintptr {
	log.Println(msg)
	// switch msg {
	// case w32.WM_COMMAND:
