...
var String2key = map[string]Key{
	"LButton":           KeyLButton,
	"RButton":           KeyRButton,
	"Cancel":            KeyCancel,
	"MButton":           KeyMButton,
	"XButton1":          KeyXButton1,
	"XButton2":          KeyXButton2,
	"Back":              KeyBack,
	"Tab":               KeyTab,
	"Clear":             KeyClear,
	"Return":            KeyReturn,
	...
	"Junja":             KeyJunja,
	"Final":             KeyFinal,
	"Hanja / Kanji":     KeyHanja,
	"Escape":            KeyEscape,
	"Convert":           KeyConvert,
	"Nonconvert":        KeyNonconvert,
	"Accept":            KeyAccept,
	"ModeChange":        KeyModeChange,
	"Space":             KeySpace,
	"Prior":             KeyPrior,
	"Next":              KeyNext,
	"End":               KeyEnd,
	...
	"Numpad8":           KeyNumpad8,
	"Numpad9":           KeyNumpad9,
	"Multiply":          KeyMultiply,
	"Add":               KeyAdd,
	"Separator":         KeySeparator,
	"Subtract":          KeySubtract,
	"Decimal":           KeyDecimal,
	"Divide":            KeyDivide,
	"F1":                KeyF1,
	"F2":                KeyF2,
	...
	"LShift":            KeyLShift,
	"RShift":            KeyRShift,
	"LControl":          KeyLControl,
	"RControl":          KeyRControl,
	"LMenu":             KeyLMenu,
	"RMenu":             KeyRMenu,
	"BrowserBack":       KeyBrowserBack,
	"BrowserForward":    KeyBrowserForward,
	"BrowserRefresh":    KeyBrowserRefresh,
	"BrowserStop":       KeyBrowserStop,
	"BrowserSearch":     KeyBrowserSearch,
	"BrowserFavorites":  KeyBrowserFavorites,
	"BrowserHome":       KeyBrowserHome,
	"VolumeMute":        KeyVolumeMute,
	"VolumeDown":        KeyVolumeDown,
	"VolumeUp":          KeyVolumeUp,
	"MediaNextTrack":    KeyMediaNextTrack,
	"MediaPrevTrack":    KeyMediaPrevTrack,
	"MediaStop":         KeyMediaStop,
	"MediaPlayPause":    KeyMediaPlayPause,
	"LaunchMail":        KeyLaunchMail,
	"LaunchMediaSelect": KeyLaunchMediaSelect,
	"LaunchApp1":        KeyLaunchApp1,
	"LaunchApp2":        KeyLaunchApp2,
	"OEM1":              KeyOEM1,
	"OEMPlus":           KeyOEMPlus,
	"OEMComma":          KeyOEMComma,
	"OEMMinus":          KeyOEMMinus,
	"OEMPeriod":         KeyOEMPeriod,
	"OEM2":              KeyOEM2,
	"OEM3":              KeyOEM3,
	"OEM4":              KeyOEM4,
	"OEM5":              KeyOEM5,
