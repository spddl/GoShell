...
func (cba *ControlBase) SetPos(x, y int) {
	...
	log.Printf("%d+%d, %d+%d\n", int(workRect.Left), x, int(workRect.Top), y)
...
// func (cba *ControlBase) MiddleMenu() *MenuItem {
// 	log.Println("MiddleMenu()")
// 	return cba.middleMenu()
// }

// func (cba *ControlBase) SetMiddleMenu(menu func() *MenuItem) {
// 	log.Println("SetMiddleMenu()")
// 	cba.middleMenu = menu
// }

func (cba *ControlBase) MiddleMenu() *MenuItem {
	// log.Println("MiddleMenu()")
	if cba.middleMenuFunc != nil {
		// log.Println("cba.middleMenuFunc != nil")
		return cba.middleMenuFunc()
	}
	return cba.middleMenu
}

func (cba *ControlBase) SetMiddleMenu(menu *MenuItem) {
	// log.Println("SetMiddleMenu()")
	cba.middleMenu = menu
}

func (cba *ControlBase) SetMiddleMenuFunc(menuFunc func() *MenuItem) {
	// log.Println("SetMiddleMenuFunc()")
	cba.middleMenuFunc = menuFunc
}
