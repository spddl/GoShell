...
func (fm *Form) WndProc(msg uint32, wparam, lparam uintptr) uintptr {
	...
	// 	fmt.Println("WM_CAPTURECHANGED", wparam, lparam)
	// case w32.WM_UNINITMENUPOPUP:
	// 	fmt.Println("WM_UNINITMENUPOPUP", wparam, lparam)
	// case w32.WM_MENUSELECT:
	// 	fmt.Println("WM_MENUSELECT", wparam, lparam)
	// case w32.WM_EXITMENULOOP:
	// 	fmt.Println("WM_EXITMENULOOP", wparam, lparam)
	// default:
