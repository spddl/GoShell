...
func RegisterApplicationRestart(pwzCommandline string, dwFlags DWORD) uint32 {
	// pwzCommandlineStr := syscall.StringToUTF16Ptr(pwzCommandline)
	pwzCommandlineStr := unicode16FromString(pwzCommandline)
	ret, _, _ := procRegisterApplicationRestart.Call(
...
func UnregisterApplicationRestart() uint32 {
