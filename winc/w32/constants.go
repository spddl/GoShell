...
// https://learn.microsoft.com/de-de/windows/win32/api/winuser/ns-winuser-windowplacement
const (
...
const (
	...
	REST_NORUN                      RESTRICTIONS = 0x00000001
	REST_NOCLOSE                    RESTRICTIONS = 0x00000002
	REST_NOSAVESET                  RESTRICTIONS = 0x00000004
	REST_NOFILEMENU                 RESTRICTIONS = 0x00000008
	REST_NOSETFOLDERS               RESTRICTIONS = 0x00000010
	REST_NOSETTASKBAR               RESTRICTIONS = 0x00000020
	REST_NODESKTOP                  RESTRICTIONS = 0x00000040
	REST_NOFIND                     RESTRICTIONS = 0x00000080
	REST_NODRIVES                   RESTRICTIONS = 0x00000100
	REST_NODRIVEAUTORUN             RESTRICTIONS = 0x00000200
	REST_NODRIVETYPEAUTORUN         RESTRICTIONS = 0x00000400
	REST_NONETHOOD                  RESTRICTIONS = 0x00000800
	REST_STARTBANNER                RESTRICTIONS = 0x00001000
	REST_RESTRICTRUN                RESTRICTIONS = 0x00002000
	REST_NOPRINTERTABS              RESTRICTIONS = 0x00004000
	REST_NOPRINTERDELETE            RESTRICTIONS = 0x00008000
	REST_NOPRINTERADD               RESTRICTIONS = 0x00010000
	REST_NOSTARTMENUSUBFOLDERS      RESTRICTIONS = 0x00020000
	REST_MYDOCSONNET                RESTRICTIONS = 0x00040000
	REST_NOEXITTODOS                RESTRICTIONS = 0x00080000
	REST_ENFORCESHELLEXTSECURITY    RESTRICTIONS = 0x00100000
	REST_LINKRESOLVEIGNORELINKINFO  RESTRICTIONS = 0x00200000
	REST_NOCOMMONGROUPS             RESTRICTIONS = 0x00400000
	REST_SEPARATEDESKTOPPROCESS     RESTRICTIONS = 0x00800000
	REST_NOWEB                      RESTRICTIONS = 0x01000000
	REST_NOTRAYCONTEXTMENU          RESTRICTIONS = 0x02000000
	REST_NOVIEWCONTEXTMENU          RESTRICTIONS = 0x04000000
	REST_NONETCONNECTDISCONNECT     RESTRICTIONS = 0x08000000
